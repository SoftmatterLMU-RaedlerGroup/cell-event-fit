...
if isempty(modelname)
	modelname = {'mRNA', 'CellROX', 'PI', 'Caspase', 'pSIVA', 'Lyso', 'TMRM', 'Calcium520', ...
				'Lyso1', 'Lyso2', 'Lyso3', 'TMRM_positive', 'TMRM_negative', ...
				'PI_old', 'PI_deriv2', 'PI_extrapol', 'pSIVA_ALL', 'pSIVA_old', 'casp_old'};
